    ...
    public class ArticuloNegocio
    {
        ...
        public void agregar(Articulo nuevo)
        {
            ...
            try
            {
                ...
                string valores = "values(" + nuevo.CodigoArticulo + ", '" + nuevo.Nombre + "', '" + nuevo.Descripcion + "', '" +  nuevo.UrlImagen + "', " + nuevo.marca.Id + ",1)";
                datos.setearConsulta("INSERT INTO ARTICULOS (Codigo , Nombre, Descripcion, ImagenUrl, IdMarca, IdCategoria)" + valores); 
